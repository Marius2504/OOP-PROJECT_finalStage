...
bool obiectePrimite::get_fix()
{
    return fix;
}
void obiectePrimite::set_fix(bool fix)
{
    this->fix=fix;
}
char obiectePrimite::get_N()
{
    return N;
}
void obiectePrimite::set_N(char N)
{
    this->N=N;
}
char* obiectePrimite::get_model()
{
    return model;
}
void obiectePrimite::set_model(char*model)
{
    if(this->model!=NULL)delete[] this->model;
    this->model=new char[strlen(model)+1];
    strcpy(this->model,model);
}
double obiectePrimite::get_profit()
{
    return profit;
}
void obiectePrimite::set_profit(double profit)
{
    this->profit=profit;
}
std::string obiectePrimite::get_numeAngajat()
{
    return numeAngajat;
}
void obiectePrimite::set_numeAngajat(std::string numeAngajat)
{
    this->numeAngajat=numeAngajat;
}
float* obiectePrimite::get_costPiese()
{
    return costPiese;
}
...
int* obiectePrimite::get_codPiese()
{
    cout<<this->codPiese<<"\n";
...
std::string* obiectePrimite::get_numePieseStricate()
{
    return numePieseStricate;
}
...
char*angajati:: get_Prenume()
{
    return this->Prenume;
}
void angajati:: set_salariu(double salariu)
{
    this->salariu=salariu;
}
double angajati::get_salariu()
{
    return this->salariu;
}
...
float* angajati::get_istoricSalariu()
{
    return this->istoricSalariu;
}
void angajati::set_istoricLuni(int istoricLuni)
{
    this->istoricLuni=istoricLuni;
}
int angajati::get_istoricLuni()
{
    return istoricLuni;
}
...
void angajati:: set_nrProiecte(int nrProiecte)
{
    this->nrProiecte= nrProiecte;
}
int angajati:: get_nrProiecte()
{
    return nrProiecte;
}
...
int produse:: get_conditie()
{
    return conditie;
}
string produse:: get_descriere()
{
    return descriere;
}
void produse::set_nume(string nume)
{
    this->nume=nume;
}
void produse::set_pret (double pret)
{
    this->pret=pret;
}
void produse::set_conditie(int conditie)
{
    this->conditie=conditie;
}
void produse::set_descriere(string descriere)
{
    this->descriere=descriere;
}
...
public:
    ...
    client(string nume,string prenume,string adresaDeEmail,string adresa,string parola, int varsta, char*produs, string defect)
    {
        this->nume=nume;
...
string client::get_adresaDeEmail()
{
    return adresaDeEmail;
}
string client::get_adresa()
{
    return adresa;
}
string client::get_parola()
{
    return this->parola;
}
...
char* client::get_produs()
{
    return produs;
}
string client::get_defect()
{
    return defect;
}
...
void client::set_adresaDeEmail(string adresaDeEmail)
{
    this->adresaDeEmail=adresaDeEmail;
}
void client::set_adresa(string adresa)
{
    this->adresa=adresa;
}
...
void client::set_produs(char * produs)
{
    if(this->produs!=NULL)delete[] this->produs;
    this->produs= new char[strlen(produs)+1];
    strcpy(this->produs,produs);
}
void client::set_defect(string defect)
{
    this->defect=defect;
}
...
public:
    ...
    client_fidel(int discount,double valTotala, string dataNastere,string nume,string prenume,string adresaDeEmail,string adresa,string parola, int varsta, char*produs, string defect):client(nume,prenume,adresaDeEmail,adresa,parola,varsta,produs,defect)
    {
...
void client_fidel::set_discount(int discount)
{
    this->discount=discount;
}
int client_fidel::get_discount()
{
...
void tehnician::set_vechime(int i)
{
    this->vechime=vechime;
}
int tehnician::get_vechime()
{
    return this->vechime;
}
///CLASA ABSTRACTA
...
public:
    ...
    friend istream& operator>>(istream& in, depozit& ob)
    {
        return in;
    }
    friend ostream& operator<<(ostream& out,const depozit& ob)
    {
        return out;
    }
    ~depozit() {};
...
public:
    ...
    void menu()
    {
    ifstream in("angajati.txt");
    ofstream out("out.out");
    int comanda=0;
    cout<<"0.Autentificare/Inregistrare\n";
    cout<<"1.Reparatii\n";
    cout<<"2.Produse\n";
    cout<<"3.Contul tau\n";
    cout<<"4.Staff\n";
    ...
    int cmd,cmd1,cmd2;
    client *listaclienti = new client[10];//lista clienti
    obiectePrimite *listaOb= new obiectePrimite[10];//lista obiecte primite de la clienti
    int indiceOb=0;
    int indice=0;//indice ultimul client
    client cl_act;

    string pi[]= {"display","rama","buton ON/OFF"};
    produse tel("Telefon SAMSUNG Galaxy A72",1550,3,"Telefon SAMSUNG Galaxy A72, 128GB, 6GB RAM, Dual SIM, Awesome Black",pi,3);
    produse tel1("Telefon SAMSUNG Galaxy A02s",499,5,"Telefon SAMSUNG Galaxy A02s, 32GB, 3GB RAM, Dual SIM, Black");
    produse tel2("Telefon HUAWEI P Smart 2021",699,5,"Telefon HUAWEI P Smart 2021, 128GB, 4GB RAM, Dual SIM, Midnight Black");
    produse tel3("Telefon APPLE iPhone 12 Pro",3499,3,"Telefon APPLE iPhone 12 Pro 5G, 128GB, Gold",pi,3);
    produse tel4("Telefon MOTOROLA Moto G9 Power",699,5,"Telefon MOTOROLA Moto G9 Power, 128GB, 4GB RAM, Dual SIM, Electric Violet");


    vector<produse*> vector_p;
    vector_p.push_back(&tel);
    vector_p.push_back(&tel1);
    vector_p.push_back(&tel2);
    vector_p.push_back(&tel3);
    vector_p.push_back(&tel4);

    map<string,string> listaAng;
    string email,parola;
    while(!in.eof())
    {
        in>>email>>parola;
        listaAng.insert(make_pair(email,parola));
    }

    list <angajati*> listaAngSesiune;
    list<angajati*>::iterator itlist;
    char nu[]="Ionel";
    char nu1[]="Maria";
    char pre[]="Popescu";
    char pre1[]="Diaconescu";
    double sal=1200;
    float cs[]= {3.4,5.6,7.8};
    string vec[]={"p1","p2","p3"};
    string vec1[]={"p1","p2"};
    angajati ang1(nu,pre,sal,cs,3,vec,3);
    angajati ang2(nu1,pre1,sal+100,cs,3,vec1,2);
    listaAngSesiune.push_back(&ang1);
    listaAngSesiune.push_back(&ang2);

    string loc="Calea plevnei nr8";
    string marfa="telefon Samsung Galaxy a8:120 bucati , Telefon MOTOROLA Moto G9 Power:99 bucati, Placa de Baza Samsung Galaxy S4 Mini I9195 Original Service Pack: 20 bucati, laca de Baza Samsung Galaxy S9 G960F 64GB Original Service Pack: cati";
    depozitChitiala dep(33,loc,335,marfa,334000);

    string marfa1="Display - Touchscreen Huawei P40 Pro: 10 bucati, Suport Card - Suport SIM Samsung Galaxy J6 J600, Albastru: 3 bucati, Senzor Amprenta Motorola Moto G9 Plus, Cu Banda, Negru: 5 bucati, Difuzor Samsung Galaxy A10s A107: 99 bucati";
    depozitChitiala dep1(32,loc,335,marfa1,275000);
    set<depozitChitiala*> listaDep;
    set<depozitChitiala*>::iterator itset;
    listaDep.insert(&dep);
    listaDep.insert(&dep1);
    ...
    while(comanda!=5)
    {
        ...
        case 0:
        {
            ...
            if(cmd1==0)
            {
                ...
                {
                    if(listaclienti[i].get_adresaDeEmail() == adresa &&
                            listaclienti[i].get_parola()==parola)
                    {
                        ok=1;
                        i=indice;
                        cl_act=listaclienti[i];
                    }
                }
                if(ok==0)
                    cout<<"\nNu exista";
        ...
        case 1:
        {
            cout<<"Bun venit in sectiunea Reparatii Device-uri!\n";
            cout<<"Doriti sa inregistrati un device?\n";
            cout<<"1-da\t0-nu\n";
            cin>>cmd;
            system("CLS");
            if(cmd !=0)
            {
                ...
                string descriere;
                cout<<"Introduceti mai jos specificatiile device-ului :";
                cin>>model;
                cout<<"\nIntroduceti o scurta descriere despre incidentul care a provocat defectiunea device-ului:";
                cin>>descriere;
                string adresa;
                cout<<"\nadresa de e-mail:";
                cin>>adresa;
                cout<<"\n1-Trimitere, 0-Anulare";
                cin>>cmd1;
                system("CLS");
                if(cmd1==1)
                {
                    if(cl_act.get_nume()=="")
                    {
                        cout<<"Doriti sa va autentificati/inregistrati?1-da 0-nu";
                        cin>>cmd2;
                        system("CLS");
                        if(cmd2==1)
                        {
                        ...
                        obiectePrimite obiect(false,'q',model,0,"",NULL,NULL,NULL,0);
                        listaOb[indiceOb]=obiect;
                    }
                }
            }
            break;
        ...
        case 2:
            {
                ...
                cout<<"\nRevin-o la meniul principal folosind tasta 9";
                cin>>cmd2;
                break;
            }
        case 3:
        {
            ...
            if(ok==0)
                cout<<"\nNu exista un cont inregistrat cu aceast e-mail\n";
            else
                cout<<cl_act;
            cout<<"\nRevin-o la meniul principal folosind tasta 9";
            cin>>cmd2;
        ...
        case 4:
        {
            ...
            if(esteAdm!=1)
            {
                ...
                for(it=listaAng.begin(); it!=listaAng.end(); it++)
                {
                    if(it->first == adresa && it->second == parola)
                        ok=1;
                }
                if(ok==0)
                    cout<<"\nNu exista";
            ...
            if(ok==1 or esteAdm==1)
            {
                cmd2=0;
                while(cmd2!=9)
                {
                    cout<<"\n1.Afisare device-uri inregistrate";
                    cout<<"\n2.Adaugare angajat";
                    cout<<"\n3.Afisare angajati din sesiune";
                    cout<<"\n4.Afisare depozite";
                    cout<<"\n5.Adaugare depozit";
                    cout<<"\n9.Iesire";
                    cin>>cmd2;
                    if(cmd2 == 1)
                    {
                        ...
                        if(indiceOb==0)cout<<"\nNu exista device-uri inregistrate momentan";
                    }
                    else if(cmd2 == 2)
                    {
                        system("CLS");
                        angajati p;
                        cin>>p;
                        listaAngSesiune.push_back(&p);

                    }
                    else if(cmd2 == 3)
                    {
                        system("CLS");
                        for(auto ir=listaAngSesiune.begin();ir!=listaAngSesiune.end();ir++)
                        cout<<(*(*ir));
                    }
                    ...
                    {
                        system("CLS");
                        for(itset=listaDep.begin(); itset!=listaDep.end(); itset++){
                            cout<<(*(*itset));
                            cout<<"\n--------------\n";}
                        if(listaDep.size() == 0)
                            cout<<"\nNu exista depozite";
        ...
        case 10:
            {
                ...
                {
                    out<<"Device "<<i;
                    out<<"\nModel: "<<listaOb[0].get_model()<<endl;
                    out<<"\nNume angajat atribuit device-ului: "<<listaOb[ind].get_numeAngajat()<<endl;
                    out<<"\nStare ";
                    if(listaOb[ind].get_fix()==false)
                        out<<" in curs de reparare"<<endl;
                    else out<<" reparat"<<endl;
                }
                out<<"Fisa tehnica se poate actualiza in orice moment in functie de durata necesara pentru a repara device-ul";
                cout<<"Procesul a fost finalizat cu succes!";
                }
                catch(exception e)
                {
                    cout<<"Procesul a esuat";
                }
               cout<<"\nRevin-o la meniul principal folosind tasta 9";
            cin>>cmd2;
            }
        ...
        cout<<"4.Staff\n";
        cout<<"5.Stop\n";
        if(cl_act.get_adresa()!="")
            cout<<"10.Printeaza chitanta";
        cout<<"\n\n\n";
        if(cl_act.get_adresa()=="")
            cout<<"NU SUNTETI AUTENTIFICAT!\n";
        else
            cout<<"Bun venit, "<<cl_act.get_nume();
        cin>>comanda;
    }
    }
};
meniu* meniu::object=NULL;
